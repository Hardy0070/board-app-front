...
const Board = () => {
  ...
  return (
    <Container maxWidth="md" style={{ marginTop: "3%", textAlign: "center" }}>
      ...
      <form>
        {board != null && (
          <input type="hidden" name="id" id="id" value={board.id}></input>
        )}
        ...
        <Grid container style={{ marginTop: "3%", textAlign: "center" }}>
          ...
          <Grid item xs={10}>
            <TextField
              ...
              value={
                board != null
                  ? board.moddate.substring(0, board.moddate.indexOf("T"))
                  : ""
              }
              aria-readonly="true"
            ></TextField>
                ...
                board.boardFileDtoList.map((boardFile, index) => (
                  ...
                  >
                    ...
                    <img
                      ...
                      id={`img${boardFile.id}`}
                      src={
                        boardFile.filetype === "image"
                          ? `https://kr.object.ncloudstorage.com/bitcamp-149/${boardFile.filepath}${boardFile.filename}`
